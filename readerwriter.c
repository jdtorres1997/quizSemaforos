...
#define SEMNAME1 "/semLec"
#define SEMNAME2 "/semEsc"

sem_t *lectores; //variable de tipo sem_t semaforo 1
sem_t *escritores; 
...
int main() {
	...
	lectores = sem_open(SEMNAME1, O_CREAT, S_IRUSR | S_IWUSR, 1);
 	escritores = sem_open(SEMNAME2, O_CREAT, S_IRUSR | S_IWUSR, 1);
